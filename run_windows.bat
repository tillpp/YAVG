...
REM powershell -Command "Invoke-WebRequest -uri '%CMAKE_URL%' -OutFile '%CMAKE_ZIP%'"
echo Extracting zip file... C:\Windows\System32\tar.exe -xf %LLVM_ZIP% --directory %ROOT%\llvm
